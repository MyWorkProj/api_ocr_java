...
public class Demo1002 {
    ...
    public static void main(String[] args) {
    	getFiles("/Users/liuxue/Documents/icard/1002");
	}
					...
					//if(!p.equals("2") && !p.equals("3") && !p.equals("反") && !p.equals("片")){
						try {
							...
							if(msg == null || msg.equals("")){
								...
								method2("/Users/liuxue/Documents/icard/1002_fail.txt", path);
							}else{
								
								method2("/Users/liuxue/Documents/icard/1002_succ.txt", (index++)+" : "+msg+" : "+path);
							}
						} catch (Exception e) {
							e.printStackTrace();
							System.out.println("====================文件处理失败=========="+file.getAbsolutePath());
