...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
    	//getFiles("/Users/liuxue/Documents/身份证信息/100");
    	
    	CommonUtil commonUtil = new CommonUtil(HOST,URL,APP_KEY,APP_SECRET,CUSTOM_HEADERS_TO_SIGN_PREFIX,"/Users/qianjianlei/txt/idCard.png");
		//CommonUtil commonUtil = new CommonUtil(HOST,URL,APP_KEY,APP_SECRET,CUSTOM_HEADERS_TO_SIGN_PREFIX,"/Users/liuxue/Downloads/80054_王卫东.jpg");
					...
					//if(!p.equals("2") && !p.equals("3") && !p.equals("反") && !p.equals("片")){
						try {
							...
							if(msg == null || msg.equals("")){
								...
								method2("/Users/liuxue/Documents/身份证信息/100_fail.txt", path);
							}else{
								
								method2("/Users/liuxue/Documents/身份证信息/100_succ.txt", (index++)+" : "+msg+" : "+path);
							}
						} catch (Exception e) {
							e.printStackTrace();
							System.out.println("====================文件处理失败=========="+file.getAbsolutePath());
