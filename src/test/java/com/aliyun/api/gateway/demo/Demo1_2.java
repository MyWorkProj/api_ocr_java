...
public class Demo1_2 {
    ...
    public static void main(String[] args) {
    	getFiles("/Users/qianjianlei/Desktop/work/idcard/佛山经纪人身份证原件+照片/佛山虚拟小号码资料收集/南海B区");
    	
    	System.out.println("====================demo1——2 over==========");
	}
					...
					////if(!p.equals("2") && !p.equals("3") && !p.equals("反") && !p.equals("片")){
						try {
							...
							if(msg == null || msg.equals("")){
								...
								method2("/Users/qianjianlei/Desktop/work/idcard/佛山经纪人身份证原件+照片/佛山虚拟小号码资料收集/佛山A区/南海B区_fail.txt", path);
							}else{
								System.out.println("====================success=========");
								method2("/Users/qianjianlei/Desktop/work/idcard/佛山经纪人身份证原件+照片/佛山虚拟小号码资料收集/佛山A区/南海B区_succ.txt", (index++)+" : "+msg+" : "+path);
							}
						} catch (Exception e) {
							e.printStackTrace();
							System.out.println("====================文件处理失败=========="+file.getAbsolutePath());
