...
import com.aliyun.api.gateway.demo.util.winshow;
/**
 * 调用示例
...
public class Demo1 {
    ...
    public static void main(String[] args) {
    	getFiles("/Users/qianjianlei/Desktop/work/idcard/test");
					...
					////if(!p.equals("2") && !p.equals("3") && !p.equals("反") && !p.equals("片")){
						try {
							...
							if(msg == null || msg.equals("")){
								...
								method2("/Users/qianjianlei/Desktop/work/idcard/test_fail.txt", path);
							}else{
								System.out.println("====================success=========");
								method2("/Users/qianjianlei/Desktop/work/idcard/test_succ.txt", (index++)+" : "+msg+" : "+path);
							}
						} catch (Exception e) {
							e.printStackTrace();
							System.out.println("====================文件处理失败=========="+file.getAbsolutePath());
