...
public class CommonUtil {
     ...
     */
    private String print(HttpResponse response) throws IOException, JSONException {
        ...
        //System.out.println("The response is:" + json);
        JSONObject resultObj = new JSONObject(json);
        String cartStr = resultObj.getJSONArray("outputs").getJSONObject(0).getJSONObject("outputValue").getString("dataValue");
        //System.out.println(cartStr);
        JSONObject jsonObj = new JSONObject(cartStr);
        ...
        String msg = name+" : 身份证 : '"+num+" : "+address+" : "+sex+" : "+nationality+" : "+birth;
        if("".equals(name) || "".equals(num) || "".equals(address) || "".equals(birth)){
        	return "";
        }
     ...
     * @throws Exception
     */
    public String HttpsPostString(String body) throws Exception {;
        Map<String, String> headers = new HashMap<String, String>();
        //（可选）响应内容序列化格式,默认application/json,目前仅支持application/json
        headers.put(HttpHeader.HTTP_HEADER_ACCEPT, "application/json");
        //（可选）Body MD5,服务端会校验Body内容是否被篡改,建议Body非Form表单时添加此Header
     ...
     * @throws Exception
     */
    public String sendPostRequestWithBody()throws Exception{
